  ...
  routes: [
    ...
    { path: '/manager', component: () =>import('../views/Manager.vue'),
      children:[
        ...
        {path: 'teacher', meta: {name:'用户(教师)信息'}, component: () =>import('../views/Teacher.vue')},
        {path: 'message', meta: {name:'留言板'}, component: () =>import('../views/Message.vue')},
        {path: 'ask', meta: {name:'提问'}, component: () =>import('../views/Ask.vue')},
        {path: 'answer', meta: {name:'答疑'}, component: () =>import('../views/Answer.vue')},
